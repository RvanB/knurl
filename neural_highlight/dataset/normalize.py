...
_EXACT = {
    "function.definition": Label.FUNCTION,
    "function.method.definition": Label.FUNCTION,
    "variable.parameter": Label.PARAMETER,
    "type.builtin": Label.TYPE,
    "type.qualifier": Label.KEYWORD,
...
_PREFIXES = (
    ...
    ("conditional", Label.KEYWORD),
    ("repeat", Label.KEYWORD),
    ("exception", Label.KEYWORD),
)
